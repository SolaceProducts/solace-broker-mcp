...
//
// Both CacheConfig fields are validated. MaxSize must be > 0 and MaxTTL must
// be > 0. A misconfigured MaxTTL of 0 (or negative) would silently make every
// Put drop as PutDroppedTTL, effectively disabling the cache — failing loud
// here surfaces the misconfiguration at startup rather than as a mysterious
