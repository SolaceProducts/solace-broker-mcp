...
// defaultMaxHonoredRetryAfter matches defaultCircuitBreakerOpenStateDuration
// — little point honoring a Retry-After longer than the breaker's own
// open-state window already pauses for.
