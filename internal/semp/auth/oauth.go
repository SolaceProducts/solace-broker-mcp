...
// exchanger is the capability OAuthAuthenticator needs from the token
...
func NewOAuthAuthenticator(exchanger exchanger, audience string, scopes []string) *OAuthAuthenticator {
