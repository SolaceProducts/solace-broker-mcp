...
func TestBrokerMetrics_Reachable(t *testing.T) {
	...
	brokerStates := func() map[string]string {
		return map[string]string{"prod": "reachable"}
	}
	if _, err := p.BrokerMetrics(brokerStates); err != nil {
		t.Fatal(err)
	}
...
func TestBrokerMetrics_Unreachable(t *testing.T) {
	...
	brokerStates := func() map[string]string {
		return map[string]string{"prod": "unreachable"}
	}
	if _, err := p.BrokerMetrics(brokerStates); err != nil {
		t.Fatal(err)
	}
...
`
	...
	const wantReason = `
# HELP mcp_broker_unreachable_reason 1 when the broker is not reachable, labelled with the failure reason.
...
func TestBrokerMetrics_CredentialInvalid(t *testing.T) {
	t.Parallel()
	...
	brokerStates := func() map[string]string {
		return map[string]string{"prod": "credential_invalid"}
	}
	if _, err := p.BrokerMetrics(brokerStates); err != nil {
		t.Fatal(err)
	}
...
func TestBrokerMetrics_AbsentBeforeFirstCall(t *testing.T) {
	...
	brokerStates := func() map[string]string { return map[string]string{} }
	if _, err := p.BrokerMetrics(brokerStates); err != nil {
		t.Fatal(err)
	}
