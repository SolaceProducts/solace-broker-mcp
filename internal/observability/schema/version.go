...
// 1.4 (SOL-153332): added the mcp_broker_authz_denied_total family. 1.5
// (SOL-152418): added the mcp_otel_metrics_exported_total and
// mcp_otel_metrics_dropped_total families.
const MetricsSchemaVersion = "1.5"
