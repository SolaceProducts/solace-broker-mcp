...
CONFIG_QUEUE_NAMES=("e2e-config-queue-broker-a" "e2e-config-queue-broker-b" "e2e-config-iso" "e2e-config-queue-sub-broker-a" "e2e-config-queue-sub-broker-b" "e2e-config-queue-owner-ok-broker-a" "e2e-config-queue-owner-ok-broker-b" "e2e-config-queue-owner-ghost-broker-a" "e2e-config-queue-owner-ghost-broker-b")
